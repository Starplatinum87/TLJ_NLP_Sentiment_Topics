...
pickle.dump(nmf_topics, open('../../data/pickles/nmf/nmf_topics_'+str(n_components)+'_bigrams.pkl', 'wb'))
pickle.dump(nmf_model, open('../../data/pickles/nmf/nmf_model_'+str(n_components)+'_bigrams.pkl', 'wb'))
pickle.dump(tfidf, open('../../data/pickles/nmf/nmf_tfidf_model_'+str(n_components)+'_bigrams.pkl', 'wb'))
pickle.dump(tlj_tfidf, open('../../data/pickles/nmf/nmf_tfidf_data_'+str(n_components)+'_bigrams.pkl', 'wb'))