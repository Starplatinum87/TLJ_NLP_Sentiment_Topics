...
# Create Bigrams
tlj_data_bigrams = [bigram_mod[doc] for doc in tlj_data_nostops]
...
tlj_data_bigram_lemmatized = lemmatization(tlj_data_bigrams, nlp, allowed_postags=['NOUN', 'ADJ', 'VERB', 'ADV'])
...
print("Bigrams LDA model execution time:", end - start)

# Pickles
pickle.dump(tlj_data_bigram_lemmatized, open('../../../data/pickles/lda/lda_gen_bigrams_lemmatized.pkl', 'wb'))
pickle.dump(id2word, open('../../../data/pickles/lda/lda_gen_bigrams_id2word.pkl', 'wb'))
pickle.dump(corpus, open('../../../data/pickles/lda/lda_gen_bigrams_corpus.pkl', 'wb'))
pickle.dump(lda_model, open('../../../data/pickles/lda/lda_gen_bigrams_model.pkl', 'wb'))