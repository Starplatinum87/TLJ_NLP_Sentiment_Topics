...
# Pickle data
pickle.dump(model_list, open('../../../data/pickles/lda/lda_gen_coherence_model_list_2.pkl', 'wb'))
pickle.dump(coherence_values, open('../../../data/pickles/lda/lda_gen_coherence_model_values_2.pkl', 'wb'))
pickle.dump(optimal_model, open('../../../data/pickles/lda/lda_gen_coherence_optimal_model_2.pkl', 'wb'))
pickle.dump((start, limit, step), open('../../../data/pickles/lda/lda_gen_coherence_topic_search_values_2.pkl', 'wb'))
